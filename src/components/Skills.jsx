...
export default function Skills() {
    return (
        <div className='border-blueBell-400 border-4 rounded-3xl  my-10 py-10 lg:mx-30 lg:px-10 md:mx-18 md:px-10 sm:mx-10 sm:px-6 mx-4 px-4'>
            ...
            <div className='grid-layout p-12'>
